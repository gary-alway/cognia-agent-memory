...
**Note:** Archived sessions stored in MinIO are automatically searched when using `recall_memories`. The system searches both active Neo4j data and archived MinIO sessions, merging and reranking results together.
...
### Logging
- Use `debug` for development to see detailed operation logs
